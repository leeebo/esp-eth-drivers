...
#define ISR_CLR_STATUS  (0xFF)  // Clear all status
...
// brief status and flag of ch390 specific registers
#define CH390_SPI_RD (0) // Burst Read Command
#define CH390_SPI_WR (1) // Burst Write Command
